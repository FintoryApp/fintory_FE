...
type NotOwnedStockChartScreenRouteProp = RouteProp<RootStackParamList, 'NotOwnedStockChart'>;
type NotOwnedStockChartNavigationProp = NativeStackNavigationProp<RootStackParamList, 'NotOwnedStockChart'>;

interface NotOwnedStockChartScreenProps {
  route: NotOwnedStockChartScreenRouteProp;
}

export default function NotOwnedStockChartScreen({route}: NotOwnedStockChartScreenProps) {
  const {stockCode, stockName, closePrice} = route.params;
  const {top} = useSafeAreaInsets();
  const navigation = useNavigation<NotOwnedStockChartNavigationProp>();
